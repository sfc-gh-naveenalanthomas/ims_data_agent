...
CREATE OR REPLACE TABLE IMS_DATA_AGENT_DB.DEMO.SAMPLE_DATA AS select * from IMS_DATA_DB.PUBLIC.SAMPLE_DATA;

CREATE OR REPLACE SECURE VIEW IMS_DATA_AGENT_DB.DEMO.SAMPLE_DATA_VW AS select * from IMS_DATA_AGENT_DB.DEMO.SAMPLE_DATA;
